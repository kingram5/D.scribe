...
export const metadata: Metadata = {
  ...
  description: `Speakers, pastors, coaches and podcasters: give your audience ${PARTNER_BONUS_INK} free Ink and ${PARTNER_DISCOUNT_PERCENT}% off their first month of D.scribe, and earn ${Math.round(PARTNER_COMMISSION_RATE * 100)}% of what they pay for a year.`,
...
const POINTS: { title: string; body: string }[] = [
  ...
  { title: `You earn ${Math.round(PARTNER_COMMISSION_RATE * 100)}%`, body: `Of everything they pay for their first ${PARTNER_COMMISSION_MONTHS} months. Counted once their 30-day refund window has passed.` },
